...
![Observing the "Proactive Remediation Device Status" blade.](/_images/image-(649Proactive-Remediation-Device-Status." "Observing the \"Proactive Remediation Device Status\" blade.").png "Observing the “Proactive Remediation Device Status” blade.")
...
!["HealthScripts.log" snippet showing if the pre-remediation (detection) script did not find the certificate already installed in the local machine's Trusted Publishers store (the Exit code of the script is 1).](/_images/image-(651HealthScripts.log\" snippet showing if the pre-remediation (detection "\"HealthScripts.log\" snippet showing if the pre-remediation (detection) script did not find the certificate already installed in the local machine's Trusted Publishers store (the Exit code of the script is 1).") script did not find the certificate already installed in the local machine's Trusted Publishers store (the Exit code of the script is 1).").png "“HealthScripts.log” snippet showing if the pre-remediation (detection) script did not find the certificate already installed in the local machine’s Trusted Publishers store (the Exit code of the script is 1).")
