...
2.  Click **Deploy** beside the relevant app.\
    ...
    ![Clicking "Deploy" beside the relevant the app](/_images/image-(417Deploy "Clicking \"Deploy\" beside the relevant the app").png "Clicking “Deploy” beside the relevant the app")

    \
    The Deployment Wizard starts.\


    !["Deployment wizard" starting](/_images/image-(533Deployment-wizard "\"Deployment wizard\" starting").png "“Deployment wizard” starting")
...
![Deployed app now appears on the "Managed" tab](/_images/image-(418Managed "Deployed app now appears on the \"Managed\" tab").png "Deployed app now appears on the “Managed” tab")