...
2. Click **Close** on the **You have successfully activated your license** dialog box.\
   \
   ![	Clicking "Close" on the "You have successfully activated your license" dialog box](/_images/image-(375-Clickingon-thedialog-box '	Clicking "Close" on the "You have successfully activated your license" dialog box').png>)\
...
3. As the terms and conditions for the MSP Plus license differ from the other PMPC Cloud license types, click **Terms and Conditions**.\
   \
   ![Clicking "Terms and Conditions"](/_images/image-(376-Clicking 'Clicking "Terms and Conditions"').png>)\
...
4.  Review the Terms and Conditions and once you are happy, click the **Accept all Terms and conditions** checkbox followed by **Confirm**.\
    \
    ![Click the "Accept all Terms and conditions" checkbox followed by "Confirm"](/_images/image-(377-Click-thecheckbox-followed-by 'Click the "Accept all Terms and conditions" checkbox followed by "Confirm"').png>)\
    \
