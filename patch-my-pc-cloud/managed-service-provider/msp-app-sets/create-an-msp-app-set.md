...
2.  Navigate to **App Sets**\
    ...
    ![Navigating to “App Sets”](/_images/image-%282546%29.png-"Navigating-to-\"App-Sets\"" "Navigating to “App Sets”")

    \
    The **App Sets** page shows any existing App Sets.\


    ![“App Sets” page showing an existing App Sets](/_images/image-%282548%29.png-"\"App-Sets\"-page-showing-an-existing-App-Sets" "“App Sets” page showing an existing App Sets")
3.  Click **Add App Set**\


    ![Clicking “Add App Set”](/_images/image-%282549%29.png-"Clicking-\"Add-App-Set\"" "Clicking “Add App Set”")
4. On the **Add App Set** screen, enter a unique name for the new App Set in the **App Set Name** field and click **Add**\
   \
   ![Specifying the name for the new App Set](/_images/image-%282551 "Specifying the name for the new App Set").png>)\
   \
...
![App Set name screen](/_images/image-%282552%29.png-"App-Set-name-screen" "App Set name screen")
...
![Clicking “Add Application” to add an application to this App Set](/_images/image-%282553%29.png-"Clicking-\"Add-Application\"-to-add-an-application-to-this-App-Set" "Clicking “Add Application” to add an application to this App Set")
...
![Selecting the relevant app you want to add from the “Select Application” dropdown](/_images/image-%282554%29.png-"Selecting-the-relevant-app-you-want-to-add-from-the-\"Select-Application\"-dropdown" "Selecting the relevant app you want to add from the “Select Application” dropdown")
...
![Modifying the “Display Name” to include the App Set’s suffix](/_images/image-%282555%29.png-"Modifying-the-\"Display-Name\"-to-include-the-App-Set’s-suffix" "Modifying the “Display Name” to include the App Set’s suffix")
...
![Clicking “Next” on the “General information” page.](/_images/image-%282556%29.png-"Clicking-\"Next\"-on-the-\"General-information\"-page." "Clicking “Next” on the “General information” page.")
...
![Configuring any required options on the “Configurations” page](/_images/image-%282557%29.png-"Configuring-any-required-options-on-the-\"Configurations\"-page" "Configuring any required options on the “Configurations” page")
...
![Selecting the assignment type for this app and clicking “Save”](/_images/image-%282558%29.png-"Selecting-the-assignment-type-for-this-app-and-clicking-\"Save\"" "Selecting the assignment type for this app and clicking “Save”")
...
1.  Click the **Assignments** tab.\
    ...
    ![Clicking the “Assignments” tab](/_images/image-%28114%29.png-"Clicking-the-\"Assignments\"-tab" "Clicking the “Assignments” tab")
...
![Clicking “Enable Update Rings”](/_images/image-%28115%29.png-"Clicking-\"Enable-Update-Rings\"" "Clicking “Enable Update Rings”")

4.  Click **Add Assignment**\
    \


    ![Clicking “Add Assignment”](/_images/image-%28116%29.png-"Clicking-\"Add-Assignment\"" "Clicking “Add Assignment”")
...
![Selecting the relevant company to assign this deployment to.](/_images/image-%28118%29.png-"Selecting-the-relevant-company-to-assign-this-deployment-to." "Selecting the relevant company to assign this deployment to.")

6. On the **Assignments** tab, select the relevant resources you want to deploy this app to and click **Save**.

![Selecting the relevant resources for this assignment](/_images/image-%28119%29.png-"Selecting-the-relevant-resources-for-this-assignment" "Selecting the relevant resources for this assignment")
...
![Configuring any required settings for the assignments](/_images/image-%28120%29.png-"Configuring-any-required-settings-for-the-assignments" "Configuring any required settings for the assignments")

9.  Click **Deploy** to deploy this App Set.\


    ![Clicking “Deploy” to deploy this App Set](/_images/image-%28122%29.png-"Clicking-\"Deploy\"-to-deploy-this-App-Set" "Clicking “Deploy” to deploy this App Set")
...
![“App Sets” showing the newly created deployment](/_images/image-%28123%29.png-"\"App-Sets\"-showing-the-newly-created-deployment" "“App Sets” showing the newly created deployment")
...
![App Set deployment when viewed from the child company](/_images/image-%28124 "App Set deployment when viewed from the child company").png>)
{% endhint %}
...
![App Set showing with a status of “Success”](/_images/image-%28125%29.png-"App-Set-showing-with-a-status-of-\"Success\"" "App Set showing with a status of “Success”")
