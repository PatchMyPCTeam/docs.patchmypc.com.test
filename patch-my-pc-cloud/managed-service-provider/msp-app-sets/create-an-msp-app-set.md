...
2.  Navigate to **App Sets**\\
    ...
    ![Navigating to "App Sets"](../../../_images/image-\(2546\).png)

    \
    The **App Sets** page shows any existing App Sets.\\

    !["App Sets" page showing an existing App Sets](../../../_images/image-\(2548\).png)
3.  Click **Add App Set**\\

    ![Clicking "Add App Set"](../../../_images/image-\(2549\).png)
...
![App Set name screen](../../../_images/image-\(2552\).png)
...
![Clicking "Add Application" to add an application to this App Set](../../../_images/image-\(2553\).png)
...
![Selecting the relevant app you want to add from the "Select Application" dropdown](../../../_images/image-\(2554\).png)
...
![Modifying the "Display Name" to include the App Set's suffix](../../../_images/image-\(2555\).png)
...
![Clicking "Next" on the "General information" page.](../../../_images/image-\(2556\).png)
...
![Configuring any required options on the "Configurations" page](../../../_images/image-\(2557\).png)
...
![Selecting the assignment type for this app and clicking "Save"](../../../_images/image-\(2558\).png)
...
1.  Click the **Assignments** tab.\\
    ...
    ![Clicking the "Assignments" tab](../../../_images/image-\(114\).png)
...
![Clicking "Enable Update Rings"](../../../_images/image-\(115\).png)

4.  Click **Add Assignment**\
    \\

    ![Clicking "Add Assignment"](../../../_images/image-\(116\).png)
...
![Selecting the relevant company to assign this deployment to.](../../../_images/image-\(118\).png)

6. On the **Assignments** tab, select the relevant resources you want to deploy this app to and click **Save**.

![Selecting the relevant resources for this assignment](../../../_images/image-\(119\).png)
...
![Configuring any required settings for the assignments](../../../_images/image-\(120\).png)

9.  Click **Deploy** to deploy this App Set.\\

    ![Clicking "Deploy" to deploy this App Set](../../../_images/image-\(122\).png)
...
!["App Sets" showing the newly created deployment](../../../_images/image-\(123\).png)
...
>
> !\[App Set deployment when viewed from the child company]\(/\_images/image-(124 "App Set deployment when viewed from the child company").png>)
...
![App Set showing with a status of "Success"](../../../_images/image-\(125\).png)
