...
!["Migrate, the Success – Deployment Created, Migration Pending" notification](/_images/image-(10 "\"Migrate, the Success – Deployment Created, Migration Pending\" notification").png)
...
![Monitoring the status of the deployment](/_images/image-(11 "Monitoring the status of the deployment").png)
