...
![Navigating to “Migration”](/_images/image%20%2814%29.png "Navigating to \"Migration\"")

3. Find the application you want to migrate.

![Finding the application to migrate.](/_images/image%20%2815%29.png "Finding the application to migrate.")
...
![No warning triangle in the “Info” column](/_images/image%20%2816%29.png "No warning triangle in the \"Info\" column")

5. If a warning triangle is shown in the **Info** column, click it to open the properties of the application.

![Warning triangle shown in the “Info” column](/_images/image%20%282715%29.png "Warning triangle shown in the \"Info\" column")

6. On the properties of the application, locate the tab(s) with a warning triangle beside them.

![Tabs with a Warning triangle beside them](/_images/image%20%282716%29.png "Tabs with a Warning triangle beside them")
...
![Clicking “Migrate” beside the relevant instance of the app.](/_images/image%20%282717%29.png "Clicking \"Migrate\" beside the relevant instance of the app.")
