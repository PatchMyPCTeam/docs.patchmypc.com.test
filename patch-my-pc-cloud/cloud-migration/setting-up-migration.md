...
!["Enable Application Migration" checkbox is checked on the "Cloud" tab](/_images/image-(2713Enable-Application-Migration "\"Enable Application Migration\" checkbox is checked on the \"Cloud\" tab").png "“Enable Application Migration” checkbox is checked on the “Cloud” tab")
...
![Verifying the "Migration" node is visible in the PMPC Cloud portal](/_images/image-(2714Migration "Verifying the \"Migration\" node is visible in the PMPC Cloud portal").png "Verifying the “Migration” node is visible in the PMPC Cloud portal")
