...
![“Dependencies” tool](/_images/image-%2888%29.png-"\"Dependencies\"-tool" "“Dependencies” tool")
...
![Clicking the &#x22;Dependencies&#x22; tool](/_images/image-%2889%29.png-"Clicking-the-&#x22;Dependencies&#x22;-tool" "Clicking the &#x22;Dependencies&#x22; tool")
...
![Selecting the relevant app that this app depends on already being successfully installed on the target device](/_images/image-%2890%29.png-"Selecting-the-relevant-app-that-this-app-depends-on-already-being-successfully-installed-on-the-target-device" "Selecting the relevant app that this app depends on already being successfully installed on the target device")

The selected app appears under the **Parent Deployment** section.

![Selected app appearing under the “Parent Deployment” section](/_images/image-%2891%29.png-"Selected-app-appearing-under-the-\"Parent-Deployment\"-section" "Selected app appearing under the “Parent Deployment” section")
...
![Viewing dependencies for an app in the Microsoft Intune admin center](/_images/image-%28339 "Viewing dependencies for an app in the Microsoft Intune admin center").png>)
...
![Clicking &#x22;Next&#x22; to move to the &#x22;Assignments&#x22; page](/_images/image-%2892%29.png-"Clicking-&#x22;Next&#x22;-to-move-to-the-&#x22;Assignments&#x22;-page" "Clicking &#x22;Next&#x22; to move to the &#x22;Assignments&#x22; page")
