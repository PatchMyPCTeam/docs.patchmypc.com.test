...
!["App Catalog" page](/_images/image-(193App-Catalog "\"App Catalog\" page").png "“App Catalog” page")
...
3.  Click the app to open its properties.\
    ...
    ![Application's "Properties" page](/_images/image-(194Properties "Application's \"Properties\" page").png "Application’s “Properties” page")
...
![Click "Deploy" to start the Deployment Wizard](/_images/image-(195Deploy "Click \"Deploy\" to start the Deployment Wizard").png "Click &#x22;Deploy&#x22; to start the Deployment Wizard")
