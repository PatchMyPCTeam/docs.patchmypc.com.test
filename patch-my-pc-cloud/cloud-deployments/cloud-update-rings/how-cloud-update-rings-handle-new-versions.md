...
![Configuring a phased deployment using Delayed Update Rings in PMPC Cloud](<../../../.gitbook/assets/image-(2199) (1).png>)
...
![Version 2019.1 successfully deployed](<../../../.gitbook/assets/image-(2201) (1).png>)
...
![Only the assignment for the first update rings has been created and applied to this version.](<../../../.gitbook/assets/image-(2202) (1).png>)
...
![Ring 2 scheduled to be created two days after the deployment was created](<../../../.gitbook/assets/image-(2203) (1).png>)
...
![Second Update Ring has been created, which has added the assignment to the “dBase All Users” group.](<../../../.gitbook/assets/image-(2204) (1).png>)
...
![Properties of the deployment showing the second Update Ring has been created and assigned to the “dBase All Users” group.](<../../../.gitbook/assets/image-(2205) (1).png>)
...
![Version 2019.2 targeted to the “dBase Pilot Users” Update Ring.](<../../../.gitbook/assets/image-(2206) (1).png>)

But if you click on **Ring 2**, you will see that version **2019.1** is still assigned to the **dBase All Users** group.

![“Ring 2” is still assigned version 2019.1 and assigned to the “dBase All Users” group](<../../../.gitbook/assets/image-(2207) (1).png>)
...
![Intune admin center shows both the existing app (version 2019.1) and the new version we have just deployed (version 2019.2).](<../../../.gitbook/assets/image-(2208) (1).png>)
...
![Updated assignment for the original version (2019.1)](<../../../.gitbook/assets/image-(2209) (1).png>)
...
![Assignments for the new deployment (version 2019.2) is only assigned for now to the dBase Pilot Users group.](<../../../.gitbook/assets/image-(2210) (1).png>)
...
![Assignments for the old version (2019.1) no longer has any assignments](<../../../.gitbook/assets/image-(2211) (1).png>)
...
![Configuring a phased deployment using Immediate Update Rings in PMPC Cloud](<../../../.gitbook/assets/image-(2212) (1).png>)

When you deploy the software, you see the **Deployment Summary** of how the deployment will be handled.

![Deployment summary summarizing how the deployment will be handled](<../../../.gitbook/assets/image-(2213) (1).png>)
...
![Version 2024.1 successfully deployed](<../../../.gitbook/assets/image-(2214) (1).png>)
...
![All assignments for each of the Update Rings created and applied to this version.](<../../../.gitbook/assets/image-(2215) (1).png>)
...
![Version 2024.2 targeted to the “Corel Pilot Users” Update Ring.](<../../../.gitbook/assets/image-(2216) (1).png>)

But if you click on **Ring 2**, you will see that version **2024.1** is still assigned to the **Corel All Users** group.

![“Ring 2” is still assigned version 2024.1 and assigned to the “Corel All Users” group](<../../../.gitbook/assets/image-(2217) (1).png>)
...
![Intune admin center shows both the existing app (version 2024.1) and the new version we have just deployed (version 2024.2).](<../../../.gitbook/assets/image-(2218) (1).png>)
...
![Updated assignment for the original version (2024.1)](<../../../.gitbook/assets/image-(2196) (1).png>)
...
![Assignments for the new deployment (version 2024.2) is only assigned for now to the Corel Pilot Users group](<../../../.gitbook/assets/image-(2197) (1).png>)
...
![Assignments for the old version (2024.1) no longer has any assignments](<../../../.gitbook/assets/image-(2198) (1).png>)
