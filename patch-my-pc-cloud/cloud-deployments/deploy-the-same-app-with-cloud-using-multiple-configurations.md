...
![“App Catalog” page](/_images/image-%28741%29.png-"\"App-Catalog\"-page" "“App Catalog” page")
...
![Clicking &#x22;Deploy&#x22; on the App&#x27;s properties page](/_images/image-%28487%29.png-"Clicking-&#x22;Deploy&#x22;-on-the-App&#x27;s-properties-page" "Clicking &#x22;Deploy&#x22; on the App&#x27;s properties page")

4. On the G**eneral Information** tab, in the **Display Name** field, enter a unique name for this deployment, then click **Next**.

![&#x22;General Information&#x22; page](/_images/image-%282615%29.png-"&#x22;General-Information&#x22;-page" "&#x22;General Information&#x22; page")
...
![&#x22;Configurations&#x22; tab](/_images/image-%282616%29.png-"&#x22;Configurations&#x22;-tab" "&#x22;Configurations&#x22; tab")

6. On the **Assignments** tab, click **Add Assignment**, then select the assignment type you want to add for this deployment.

![Clicking &#x22;Add Assignment&#x22;, then selecting the assignment type you want to add for this deployment](/_images/image-%282617%29.png-"Clicking-&#x22;Add-Assignment&#x22;,-then-selecting-the-assignment-type-you-want-to-add-for-this-deployment" "Clicking &#x22;Add Assignment&#x22;, then selecting the assignment type you want to add for this deployment")

7. On the **Add <**_**assignment\_type**_**> Assignment** page, select the relevant options, then click **Save**.

![](/_images/image-%282618%29.png-"" "")
...
![New assignment shown on the “Assignments” page](/_images/image-%282619%29.png-"New-assignment-shown-on-the-\"Assignments\"-page" "New assignment shown on the “Assignments” page")

8. Configure the settings for deployment, if required.

![Configure any required settings](/_images/image-%282620%29.png-"Configure-any-required-settings" "Configure any required settings")
...
![Adding  any additional assignments for this deployment by clicking &#x22;Add Assignment&#x22;](/_images/image-%282621%29.png-"Adding-any-additional-assignments-for-this-deployment-by-clicking-&#x22;Add-Assignment&#x22;" "Adding  any additional assignments for this deployment by clicking &#x22;Add Assignment&#x22;")

10. Review the deployment summary shown on the **Summary** page.\
    \
    If you are happy, click **Deploy**.

![Clicking &#x22;Deploy&#x22;](/_images/image-%282622%29.png-"Clicking-&#x22;Deploy&#x22;" "Clicking &#x22;Deploy&#x22;")
