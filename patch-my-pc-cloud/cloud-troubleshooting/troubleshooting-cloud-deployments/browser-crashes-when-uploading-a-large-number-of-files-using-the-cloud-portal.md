...
![Adding the “MyFolder.zip” as an Extra File](../../../.gitbook/assets/image-\(2381\).png)
...
![Uploading the extraction script as a Pre-Install Script in your deployment settings](../../../.gitbook/assets/image-\(2382\).png)
