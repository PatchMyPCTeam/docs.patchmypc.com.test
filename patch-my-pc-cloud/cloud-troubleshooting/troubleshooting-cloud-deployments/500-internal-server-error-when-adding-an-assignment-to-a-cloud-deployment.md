...
![“500 Internal Server Error” when trying to add an assignment](/_images/image-(764 "“500 Internal Server Error” when trying to add an assignment").png "“500 Internal Server Error” when trying to add an assignment")
