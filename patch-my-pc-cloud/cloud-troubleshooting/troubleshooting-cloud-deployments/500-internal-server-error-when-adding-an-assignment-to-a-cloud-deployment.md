...
!["500 Internal Server Error" when trying to add an assignment](/_images/image-(764500-Internal-Server-Error "\"500 Internal Server Error\" when trying to add an assignment").png "“500 Internal Server Error” when trying to add an assignment")
