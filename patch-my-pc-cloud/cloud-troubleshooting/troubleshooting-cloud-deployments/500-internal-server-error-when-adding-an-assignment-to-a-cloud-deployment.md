...
![“500 Internal Server Error” when trying to add an assignment](/_images/image-%28764%29.png-"\"500-Internal-Server-Error\"-when-trying-to-add-an-assignment" "“500 Internal Server Error” when trying to add an assignment")
