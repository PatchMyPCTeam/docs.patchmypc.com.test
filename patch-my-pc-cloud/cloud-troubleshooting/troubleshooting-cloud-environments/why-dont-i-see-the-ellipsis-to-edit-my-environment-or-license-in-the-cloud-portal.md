...
![Missing ellipsis on the "Environments" page](/_images/image-(1754 "Missing ellipsis on the \"Environments\" page").png)
...
![Ellipsis now visible](/_images/image-(1756 "Ellipsis now visible").png)

The scrollbar under the table gives you a visual clue that the browser window is not wide enough to display everything.

![Scrollbar is a visual clue](/_images/image-(1757 "Scrollbar is a visual clue").png)
