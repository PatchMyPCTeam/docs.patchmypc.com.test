...
![No "Discovery" node](/_images/image-(526Discovery "No \"Discovery\" node").png "No “Discovery” node")
...
!["Discovery" node now visible](/_images/image-(527Discovery "\"Discovery\" node now visible").png "“Discovery” node now visible")