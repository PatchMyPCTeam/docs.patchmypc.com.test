...
!["Customer has active connections. Please disconnect them first in order to delete the company" error](/_images/image-(374 "\"Customer has active connections. Please disconnect them first in order to delete the company\" error").png)
