...
![Required app missing from the "App Dependencies" dropdown](/_images/image-(2274App-Dependencies "Required app missing from the \"App Dependencies\" dropdown").png "Required app missing from the “App Dependencies” dropdown")
