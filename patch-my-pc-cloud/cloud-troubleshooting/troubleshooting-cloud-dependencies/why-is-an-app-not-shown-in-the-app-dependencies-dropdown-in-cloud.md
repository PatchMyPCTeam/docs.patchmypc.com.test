...
I am trying to use the _App Dependencies_ feature of Patch My PC (PMPC) Cloud, but when I click on the <strong>App Dependencies</strong> dropdown, I do not see the app I need to ensure is installed on the device before the app I am trying to deploy.
