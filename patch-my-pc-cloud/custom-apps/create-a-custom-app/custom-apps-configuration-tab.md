...
![Configuring the &#x22;Silent Install Parameters&#x22; for this app](/_images/image-%2843%29.png-"Configuring-the-&#x22;Silent-Install-Parameters&#x22;-for-this-app" "Configuring the &#x22;Silent Install Parameters&#x22; for this app")
...
![Entering the version number for this app.](/_images/image-%2842%29.png-"Entering-the-version-number-for-this-app." "Entering the version number for this app.")

3. In the **Language** field, either type the language for this app or select it from the dropdown list.

![Configuring the language for the app](/_images/image-%2841%29.png-"Configuring-the-language-for-the-app" "Configuring the language for the app")
...
![Entering the &#x22;Apps &#x26; Feature Name&#x22;](/_images/image-%2844%29.png-"Entering-the-&#x22;Apps-&#x26;-Feature-Name&#x22;" "Entering the &#x22;Apps &#x26; Feature Name&#x22;")
...
![Adding a new Return Code](/_images/image-%282625%29.png-"Adding-a-new-Return-Code" "Adding a new Return Code")

The new Return Code is added to the list.

![New Return Code added to the list.](/_images/image-%282626%29.png-"New-Return-Code-added-to-the-list." "New Return Code added to the list.")

9. If you do not want to edit a Return Code, go to Step 13.
10. To edit a Return Code, click the pencil icon beside it.

![Clicking the pencil icon beside a Return Code to edit it.](/_images/image-%282627%29.png-"Clicking-the-pencil-icon-beside-a-Return-Code-to-edit-it." "Clicking the pencil icon beside a Return Code to edit it.")

11. Choose the correct **Code type** for this Return Code from the dropdown list.

![Choosing the correct “Code type” from the dropdown list](/_images/image-%282628%29.png-"Choosing-the-correct-\"Code-type\"-from-the-dropdown-list" "Choosing the correct “Code type” from the dropdown list")

12. Click the green tick to save your changes.

![Clicking the green tick.](/_images/image-%282629%29.png-"Clicking-the-green-tick." "Clicking the green tick.")

The **Code type** field is updated.

![“Code type” field updated.](/_images/image-%282630%29.png-"\"Code-type\"-field-updated." "“Code type” field updated.")
...
![Deleting a Return Code](/_images/image-%282631%29.png-"Deleting-a-Return-Code" "Deleting a Return Code")

The code is deleted from the list.

![Code deleted from the list](/_images/image-%282632%29.png-"Code-deleted-from-the-list" "Code deleted from the list")
