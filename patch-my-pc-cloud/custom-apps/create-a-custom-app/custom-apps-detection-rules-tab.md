...
<figure><img src="../../../_images/gitbook/image (196).png" alt="Clicking “Use Custom” to use a custom detection rule and choosing the relevant type of rule from the “Rule Type” dropdown"><figcaption></figcaption></figure>

2. Go to Step 8 if you chose the **Use Custom Script** option.
3.  If you choose the **Configure Manually** option, click **Add Rule**.\


    <figure><img src="../../../_images/gitbook/image (197).png" alt="Clicking “Add Rule”"><figcaption></figcaption></figure>
...
4.  On the **Add Detection Rule** screen, select the relevant type of rule from the **Rule Type** dropdown, then configure the required options as required.\
    ...
    <figure><img src="../../../_images/gitbook/image (199).png" alt="Selecting the relevant type of rule to configure from the “Rule Type” dropdown." width="380"><figcaption></figcaption></figure>
...
5.  If you have created either a **File** or **Registry** detection rule, click the **Associated with a 32-bit app on 64-bit clients** slider to enable it to expand any path environment variables in the 32-bit context on 64-bit endpoints.\
    ...
    <figure><img src="../../../_images/gitbook/image (200).png" alt="Enabling the “Associated with a 32-bit app on 64-bit clients slider”" width="377"><figcaption></figcaption></figure>


6.  Click **Add Rule** to add the rule.\


    <figure><img src="../../../_images/gitbook/image (201).png" alt="Clicking “Add Rule” to add a rule" width="377"><figcaption></figcaption></figure>

    \
    The rule is added to the list of detection rules.\


    <figure><img src="../../../_images/gitbook/image (202).png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../../_images/gitbook/image (203).png" alt="Clicking “Import Script”"><figcaption></figcaption></figure>
...
<figure><img src="../../../_images/gitbook/image (204).png" alt="Preview of the script shown in the &#x22;Script Preview&#x22; window."><figcaption></figcaption></figure>
...
9.  Click the **Associated with a 32-bit app on 64-bit clients** slider to enable it to expand any path environment variables in the 32-bit context on 64-bit endpoints.\
    ...
    <figure><img src="../../../_images/gitbook/image (205).png" alt="Enabling the “Associated with a 32-bit app on 64-bit clients slider”"><figcaption></figcaption></figure>
