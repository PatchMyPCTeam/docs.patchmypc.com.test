...
You can also access this page from within the Cloud Portal by clicking the support button (!["support" button](/_images/image-%28587 "\"support\" button").png>)) in the header area and selecting **Release Notes**.
{% endhint %}
