...
1.  In the PMPC Cloud portal, navigate to **Settings | Users**.\
    ...
    ![Navigating to "Settings | Users"](/_images/image-(2245Settings-Users "Navigating to \"Settings | Users\"").png "Navigating to “Settings | Users”")


2.  Click **Entra ID Groups**.\


    ![Clicking "Entra ID Groups"](/_images/image-(2246Entra-ID-Groups "Clicking \"Entra ID Groups\"").png "Clicking “Entra ID Groups”")
