...
!["Entra ID Groups" tab on the "Users" node](/_images/image-(2255Entra-ID-Groups "\"Entra ID Groups\" tab on the \"Users\" node").png "“Entra ID Groups” tab on the “Users” node")
