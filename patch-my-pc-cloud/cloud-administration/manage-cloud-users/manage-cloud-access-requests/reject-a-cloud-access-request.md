...
1.  Click the red **X** in the **Action** column beside the access request you want to reject.\
    ...
    ![Selecting the Access Request to Reject](/_images/image-%28623%29.png-"Selecting-the-Access-Request-to-Reject" "Selecting the Access Request to Reject")
...
2.  On the **Reject request from "<**_**user\_name**_**>"** dialog box, enter an optional **Reason for Deny** then, click **Submit** to confirm your rejection.\
    ...
    ![“Success- Request rejected” notification](/_images/image-%28625%29.png-"\"Success-Request-rejected\"-notification" "“Success- Request rejected” notification")
