...
!["Cloud" tab of our Publisher](/_images/image-(1725Cloud "\"Cloud\" tab of our Publisher").png "&#x22;Cloud&#x22; tab of our Publisher")
...
![Entering a "Connection Name" and clicking "Connect"](/_images/image-(1726Connection-Name "Entering a \"Connection Name\" and clicking \"Connect\"").png "Entering a “Connection Name” and clicking “Connect”")
...
7.  In your browser, enter the Entra ID you used to onboard to PMPC Cloud or click to select the relevant account from the list of already signed-in accounts. Then click **Next**.\
    ...
    !["Microsoft Sign in" screen](/_images/image-(1420Microsoft-Sign-in "\"Microsoft Sign in\" screen").png "“Microsoft Sign in” screen")


8.  Enter the password and click **Sign in**.\


    !["Enter password" screen](/_images/image-(1421Enter-password "\"Enter password\" screen").png "“Enter password” screen")
...
10. If the **Edit a customer** screen is displayed, click to select the customer you want to connect to, then click **OK**.\
    ...
    ![Selecting the relevant customer from the "Edit a customer" screen](/_images/image-(910Edit-a-customer "Selecting the relevant customer from the \"Edit a customer\" screen").png "Selecting the relevant customer from the “Edit a customer” screen")


11. In Publisher, verify the **Connection Status** shows as **Connected**, then click **Save and Close**.\


    ![Publisher showing it's "Connected"](/_images/image-(1728Connected "Publisher showing it's \"Connected\"").png "Publisher showing it’s “Connected”")
