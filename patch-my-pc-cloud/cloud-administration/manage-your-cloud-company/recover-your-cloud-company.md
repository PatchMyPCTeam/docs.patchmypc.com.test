...
5.  On the **Select the Company You Want to Sign In To** screen, click **Recover Company**.\
    ...
    ![Clicking "Recover Company"](/_images/image-(1955Recover-Company "Clicking \"Recover Company\"").png "Clicking “Recover Company”")

    \
    The **Claim Ownership** wizard starts.\


    !["Claim Ownership" wizard](/_images/image-(2190Claim-Ownership "\"Claim Ownership\" wizard").png "“Claim Ownership” wizard")


6.  From the **Company to Claim** dropdown, select the company you want to recover.\


    !["Company to Claim" dropdown](/_images/image-(2191Company-to-Claim "\"Company to Claim\" dropdown").png "“Company to Claim” dropdown")
...
![Completed "Claim Ownership" wizard](/_images/image-(2195Claim-Ownership "Completed \"Claim Ownership\" wizard").png "Completed “Claim Ownership” wizard")

10. Click **Continue**.\


    ![Clicking "Continue"](/_images/image-(2194Continue "Clicking \"Continue\"").png "Clicking &#x22;Continue&#x22;")
...
12. If the user performing the recovery is not an existing user within the PMPC Company, they will see the **User Info** page.\
    ...
    !["User Info" page](/_images/image-(1962User-Info "\"User Info\" page").png "“User Info” page")
...
14. Review the **Terms and conditions** and if you are happy, click to check the **Accept all Terms and conditions** checkbox, then click **Continue**.\
    ...
    ![Checking the "Accept all Terms and conditions" checkbox, then clicking "Continue".](/_images/image-(1963Accept-all-Terms-and-conditions." "Checking the \"Accept all Terms and conditions\" checkbox, then clicking \"Continue\".").png "Checking the “Accept all Terms and conditions” checkbox, then clicking “Continue”.")
...
15. The supplied information is checked.\
    ...
    !["Ownership Granted" popup](/_images/image-(1965Ownership-Granted "\"Ownership Granted\" popup").png "“Ownership Granted” popup")
...
16. Click **Close** to complete the recovery process and display the **App Catalog** page of the recovered company.\
    ...
    !["App Catalog" page of the recovered company](/_images/image-(1966App-Catalog "\"App Catalog\" page of the recovered company").png "“App Catalog” page of the recovered company")
    ...
    !["Users" node showing the user account used to perform the recovery process has been created (if applicable) and assigned the "Full Admin with Access Management role".](/_images/image-(1967Users "\"Users\" node showing the user account used to perform the recovery process has been created (if applicable) and assigned the \"Full Admin with Access Management role\".") and assigned the \"Full Admin with Access Management role\".").png "“Users” node showing the user account used to perform the recovery process has been created (if applicable) and assigned the “Full Admin with Access Management role”.")
