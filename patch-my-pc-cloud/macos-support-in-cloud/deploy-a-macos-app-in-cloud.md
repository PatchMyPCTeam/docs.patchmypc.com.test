...
1.  Locate the required app on the App Catalog page.\
    ...
    <figure><img src="../../_images/gitbook/image (2285).png" alt="Locating the app to be deployed"><figcaption></figcaption></figure>
...
2.  Click the relevant app.\
    ...
    <figure><img src="../../_images/gitbook/image (2286).png" alt="Clicking the relevant app"><figcaption></figcaption></figure>


3.  On the app’s properties page, click **Deploy** under the **macOS** section to start the Deployment Wizard.\


    <figure><img src="../../_images/gitbook/image (291).png" alt="Clicking “Deploy” under the “macOS” section"><figcaption></figcaption></figure>
...
![Successful deployment visible in the Microsoft Intune admin center](<../../_images/gitbook/image (2289).png>)
{% endhint %}
...
!["Uninstall Assignments disabled as you have added a pre/post-install script."](<../../_images/gitbook/image (2395).png>)
