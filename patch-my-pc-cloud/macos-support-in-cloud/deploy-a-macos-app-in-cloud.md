...
<p>!["Uninstall Assignments disabled as you have added a pre/post-install script."](/_images/post-install-script."' '"Uninstall Assignments disabled as you have added a pre/post-install script."').png>)</p>
