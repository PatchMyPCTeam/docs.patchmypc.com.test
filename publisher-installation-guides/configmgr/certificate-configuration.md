...
![Enable Third  Party Updates and allow Configuration Manager to manage the certificate.](/_images/image-%281112 "Enable Third  Party Updates and allow Configuration Manager to manage the certificate.").png>)
...
![Synchronize Software Updates to generate a new certificate](/_images/image-%281157 "Synchronize Software Updates to generate a new certificate").png>)
...
![Here the certificate exists but has not been checked, select Show Certificate](/_images/image-%281195 "Here the certificate exists but has not been checked, select Show Certificate").png>)

![Here is the information around the generated certificate](/_images/image-%281078 "Here is the information around the generated certificate").png>)

![Note how the checkbox is now green. You are ready to start publishing updates!](/_images/image-%281245 "Note how the checkbox is now green. You are ready to start publishing updates!").png>)
