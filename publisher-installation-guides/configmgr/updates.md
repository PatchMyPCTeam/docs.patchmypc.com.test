...
![Feature enablement for updates](/_images/image%20%281069).png>)
...
![Select the search icon](/_images/image%20%281190).png>)

When you select the search button a dialogue will open, type in one of our example products and hit enter, or click **OK**.

![Search box options for the Updates Tab](/_images/image%20%281165).png>)
...
![Select a product and hit apply so save the configuration.](/_images/image%20%281271).png>)
...
![Configure Software Update Point Tab](/_images/image%20%281091).png>)
...
![Enable the patch my pc product category.](/_images/image%20%281129).png>)
