...
![](/_images/image%20%281937%29.png "Link location to create api credentials")
...
![This image showcases the Hp Proactive Insights API web page, with the error You do not have appropriate permissions (role) to access any of this Tech Groups published Apis](/_images/hp%20no%20api%20%281%29.png "HP enrolment error")

#### Credentials creation flow

![](/_images/image%20%281938%29.png "Credentials creation form")
...
![](/_images/image%20%281940%29.png "Complete example of credentials creation")

Click create and you will be redirected back to the previous page.

#### Viewing app

![](/_images/image%20%281941%29.png "Green banner showing creation was successful")
...
![](/_images/image%20%281942%29.png "App listing with newly created app")

Now click on the newly created app by click the app name, this will load the app details page.

![](/_images/image%20%281944%29.png "App details page")
...
![](/_images/image%20%281866%29.png "Settings page in Advanced Insights")
...
![](/_images/image%20%281876%29.png "HP Workforce Experience welcome page")

![](/_images/image%20%281877%29.png "Sign up or login using either a Microsoft Account to or HPID account")

![](/_images/image%20%281879%29.png "Create HP Workforce Experience Account")

![](/_images/image%20%281880%29.png "Account creation dialog")

![](/_images/image%20%281882%29.png "Accepting the ToS")
...
![](/_images/image%20%281838%29.png "HP Workforce Experience homepage with assets link highlighted")
...
![](/_images/image%20%281840%29.png "Assets page with assets imported")

![](/_images/image%20%281841%29.png "Add button for device import")

### Intune import

To begin importing from Intune, please click the Intune Import button then click next.

![](/_images/image%20%281843%29.png "The import modal, please click Intune Import then next")
...
![](/_images/image%20%281844%29.png "Location of tenant domain name, via Intune portal.")

![](/_images/image%20%281845%29.png "Adding our tenant domain name to HP.")
...
![](/_images/fixed.png "Permissions required by HP.")
...
![](/_images/image%20%281847%29.png "Filtered group for HP devices only")
...
![](/_images/image%20%281850%29.png "")
...
![](/_images/image%20%281868%29.png "Warranty dashboard")

You will be asked to log in to HP, click yes and Advanced Insights will go to HP to log in.&#x20;

![](/_images/image%20%281869%29.png "HP login warning")
...
![](/_images/image%20%281836%29.png "HP Warranty data listed in Advanced Insights")
