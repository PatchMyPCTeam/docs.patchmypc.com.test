...
![](/_images/image002%20%282%29.png "")
...
![](/_images/image%20%281258%29.png "Inventory Classes displayed In Hardware Inventory Client Settings")
...
![](/_images/image%20%281325%29.png "ConfigMgr package \"PMPC Data Collection (LEGACY)\" to remove")
...
![](/_images/image%20%281321%29.png "Advanced Insights Inventory Extensions app in the PMPC Publisher")
...
![](/_images/image%20%281326%29.png "Choose \"Selective sync\" to publish the MSI quickly to ConfigMgr")

3\. On the **Sync Schedule** tab, click **Run Publishing Service Sync.**

![](/_images/image%20%281327%29.png "Publisher Sync")

4\. Verify the **Inventory Extensions x.x.x.x (MSI-x64)** application was created and deploy it to your desired collection(s).

![](/_images/image%20%281329%29.png "Inventory Extensions app created successfully")
